...
import {
  buildCashClosuresCsv,
  buildFinanceCsv,
  buildOrdersCsv,
  buildPeriodRange,
  buildTimeline,
  diffMinutes,
  CASH_CLOSURE_STORAGE_KEY,
  CASH_DIFF_ALERT_THRESHOLD,
  CRITICAL_DELAY_MINUTES,
  DEFAULT_SERVE_TARGET_MINUTES,
  DELAY_MINUTES,
  formatCurrency,
  formatDate,
  formatDuration,
  ...
  median,
  minutesSince,
  normalizeRealtimeOrder,
  playNewOrderTone,
  REFRESH_INTERVAL_MS,
  statusStyle,
} from './commandeUtils';
import CommandeAuthGate from './CommandeAuthGate';
...
export default function CommandePanel({ interfaceType = 'staff' }) { // eslint-disable-line react/prop-types
  ...
  return (
    <CommandeAuthGate
      session={session}
      allowed={allowed}
      canSeeStaffDashboard={canSeeStaffDashboard}
      hasManagerRole={hasManagerRole}
      isManagerInterface={isManagerInterface}
